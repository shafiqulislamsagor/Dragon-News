...
import { getItems, setItems } from "../localStorage/LocalStore";

const Theme = () => {
    const [theme, setTheme] = useState(false)

    const MoodChangeHandle = () => {
        setItems(!theme)
        setTheme(!theme)
    }
    useEffect(() => {
        const search = getItems()
        setTheme(search)
    }, [])
    // console.log(theme);
    return (
        <div>
            <div className="lg:hidden w-4/5 mx-auto">
                <label className="swap swap-rotate">
                    ...
                    <input onChange={MoodChangeHandle} type="checkbox" className="theme-controller" value={theme ? 'synthwave' : 'dark'} checked={theme} />
            ...
            <div className="hidden lg:block">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
                    <input onChange={MoodChangeHandle} type="checkbox" value={theme ? 'synthwave' : 'dark'} checked={theme} className="toggle theme-controller" />
